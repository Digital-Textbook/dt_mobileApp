...
//     cid_no: Yup.string().required("Cid No / Permit No is required"),
            ...
            try {
                ...
                if (error.response) {
                    ...
                    if (status === 409) {
                        ...
                        setFieldError('cid_no', data.message || 'An error occurred. Please try again.');
                    }
                } else if (error.request) {
                    setFieldError('cid_no', 'Network error. Please check your internet connection.');
                } else {
                    setFieldError('cid_no', 'An unexpected error occurred. Please try again.');
                }
            }
